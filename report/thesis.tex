...
\bibliography{references,references/images.bib,references/techpapers.bib,references/design.bib,references/implementation.bib,references/benchmark.bib}                           %Bibliography file called

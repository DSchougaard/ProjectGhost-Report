...
\label{chap:analysis}
	...
	\section{Academic Research and Tools}
		...
		\subsection*{Final Comparison}
			Whereas the other comparison section was very clear cut, in regards to the initial requirements, this section will have to be a little more lenient. Since it is technical papers that are being reviewed, certain features has to be considered trivial and should be part of the solution.
...
\label{chap:analysis}
			...
			\begin{table}
				\begin{minipage}{1.0\textwidth}
					\begin{tabular}{|r l l|}
						...
						\hline
						Rattic 				& Yes 													& Yes\footnote{Databases other than MySQL receives less testing.} 	\\
						Passwordstate 		& No 													& No 																\\
						TeamPasswordManager & Yes 													& No 																\\
						Simple Safe 		& Yes  													& No 																\\
						Passwork 			& N/A\footnote{No information available to determine.} 	& N/A\footnote{No information available to determine.} 				\\
						SimpleVault 		& Yes 													& No\footnote{Doesn't use a database. Stores passwords in a .txt file.} 				\\
						TeamPass 			& Yes 													& No 																\\
						Vaultier 			& Yes 													& No 																\\
						\hline
					\end{tabular}
				...
				\caption{Comparison agnosticity of self-hostable soloutions.}
				\label{tbl:agnostic}
			\end{table}
	...
	\section{Academic Research and Tools}
		...
		\subsection*{Sesame: A Secure and Convenient Mobile Solution for Passwords}
			...
			While the idea is novel, and some user might find it exciting and usable, it is fairly limited in regards to platforms. As the authors write themselves, it is inteded for smartphone, tablets, smartwatches etc. Hence, the usage for the problem at hand is rather limited.

...
\label{chap:analysis}
	...
	\section{Existing Available Tools}
		...
		\begin{itemize}
			...
			\item RoboForm (http://roboform.com)
		...
		\subsection{SimpleSafe}
			...
			\begin{figure}[htbp]
				\centering
				\includegraphics[width=0.95\textwidth]{figures/analysis/simplesafe_groups.png}
		...
		\subsection{PassWork}
			PassWork\cite{passwork} is yet another take, on the same type of solution as SimpleSafe, Rattic, TeamPasswordManager, and Passwordstate. Passwork organises passwords in groups, which in return can contain sub-groups, or folders if you will. Each group has a list of users, currently allowed to access passwords in said group.

\chapter{Designing the System}
	...
	\section{Securing the Communication}
		...
		As such, it is almost \emph{required} to heavily limit the available options for SSL/TLS on a service, for it to be considered ``safe''. Table \ref{table:ssl/tls} on page \pageref{table:ssl/tls} contains some of the more recent attacks, and what their target is.
		...
		POODLE 			SSL 3.0 (Possibly even 1.1?! https://www.globalsign.com/en/blog/poodle-vulnerability-expands-beyond-sslv3-to-tls/) 
									https://support.globalsign.com/customer/portal/articles/1786853-poodle-vulnerability-affects-tls-1-0-tls-1-1
		DROWN  			SSL 2.0
		BEAST 			TLS 1.0
		Heartbleed 		Everything
		Bar Mitzvah 	Deprecated RC4 Chipers
		FREAK 			Everything, if using RSA\_EXPORT ciphers https://freakattack.com/

\chapter{Designing the System}
	...
	\section{Auditing of Access}
		...
		\begin{tabular}{r | c | c | c }
			...
			Read 		& \xmark 						& \cmark 					& \xmark 						\\
			Update 		& \xmark 						& \cmark 					& \xmark 						\\
			Delete 		& \xmark 						& \cmark 					& \xmark 						\\
		\end{tabular}
		...
		\subsection{Comparison With Requirements}
			Having decided on what data should be logged for audit, it is concluded that the solution now fulfil the following requirement:
			\begin{itemize}
	...
	\section{Modelling the System}
		...
		\subsection{The Audit Model}
			...
			\begin{figure}[p]
				\centering
				\includegraphics[scale=0.75]{figures/design/uml/audit-user-password-shared-password-erd.eps}
				\caption{Audit models relationship with the User, Password, and Shared Password models.}

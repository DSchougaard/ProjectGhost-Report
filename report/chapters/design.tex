	...
	\section{Authentication}
		...
		\subsection{Multi-Factor Authentication}
			...
			\subsubsection{Choosing the Second Factor}
				Using ``something you have'' is bar far the easiest additional security factor to add, to an online system. Some companies do this by providing physical tokens and some by developing their own internal system and accompanying app \emph{(Blizzard Entertainment, for instance)}. While this definitely is an option, it is also by far the most expensive. Dedicated hardware needs to be manufactured, or a separate application needs to be developed.

				A far more universal -- and partially plug and play -- approach exists, in the two most common algorithms: HMAC-Based One-Time Password Algorithm\cite{rfc4226}, commonly known as HOTP, and Time-Based One-Time Password Algorithm\cite{rfc6238}, commonly known as TOTP.

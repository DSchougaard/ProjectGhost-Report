	...
	\section{Final Comparison with the Requirements}
		\begin{table}[h!]
			\begin{tabular}{r l c}
				...
				\hline
				\freq{item:platform} 			& \red{\xmark} 			& \red{ \ref{requirement:fulfilled:platform} }			\\
				\hline
				\freq{item:database} 			& \red{\xmark} 			& \red{ \ref{requirement:fulfilled:database} }			\\
				\hline
				...
				\hline
				\nfreq{item:entries} 			& \red{\xmark} 			& \red{ \ref{requirement:fulfilled:entries} }			\\
				\hline

\chapter{Designing the System}
	...
	\section{User Structure \& Creation}
		\label{sec:user:diff}
		As per the requirements there need to be differentiation between regular users and an admin user. This is done to make sure that certain administrative functions are not available to users. There are two different schools of thought when it comes to user differentiation: The simple approach and the sophisticated approach.
